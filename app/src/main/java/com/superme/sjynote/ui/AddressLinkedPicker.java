package com.superme.sjynote.ui;
...
import com.superme.sjynote.ui.pickerutils.BaseWheelPicker;
import com.superme.sjynote.ui.pickerutils.LinkedFirstItem;
import com.superme.sjynote.ui.pickerutils.LinkedFourItem;
import com.superme.sjynote.ui.pickerutils.LinkedSecondItem;
import com.superme.sjynote.ui.pickerutils.LinkedThirdItem;
...
//    }
    ...
    private void buildPicker() {
        ...
        firstView.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.WRAP_CONTENT, firstColumnWeight));
        addView(firstView);
        //01标签
        ...
        secondView.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.WRAP_CONTENT, firstColumnWeight));
        addView(secondView);
        //02标签
        ...
        if (provider.showNum >= 3) {
            thirdView.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.WRAP_CONTENT, firstColumnWeight));
            addView(thirdView);
            //03标签
        ...
        if (provider.showNum >= 4) {
            fourthView.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.WRAP_CONTENT, firstColumnWeight));
            addView(fourthView);
            //04标签
        ...
        if (provider.showNum == 5) {
            fifthView.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.WRAP_CONTENT, firstColumnWeight));
            addView(fifthView);
            //05标签
